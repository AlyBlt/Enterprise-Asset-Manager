...
namespace AssetManager.Application.Validators.Asset
{
    public class CreateAssetRequestDtoValidator : AbstractValidator<CreateAssetRequestDto>
    {
        public CreateAssetRequestDtoValidator()
        {
